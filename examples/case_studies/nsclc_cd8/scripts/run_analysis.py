#!/usr/bin/env python3
"""
Reproducible analysis entry point for the NSCLC CD8+ T cell case study.

This script wires together target QC, baseline scoring, and (optionally) metric
scoring so the accompanying README instructions can be executed end-to-end.
"""
