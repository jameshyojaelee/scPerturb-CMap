#!/usr/bin/env python3
"""
Workflow runner for the IFN-high macrophage case study.

Executes a minimal pipeline (target QC + scoring) so readers can reproduce the
results described in the documentation.
"""
